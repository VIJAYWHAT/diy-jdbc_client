 ...
 *                 used for SQL types that require specific type information
     ...
     * @return a new Query instance for execution
     */
    public <T> SingleRecordQuery<T> queryForOne(
     ...
     * @return a new Query instance for execution
     */
    public <T> MultipleRecordQuery<T> queryForList(
            final RowMapper<T> rowMapper) {
     ...
     * @return a new Query instance for execution
     */
    public <T> SingleGeneratedKeysQuery<T> queryGeneratedKeys(
            final RowMapper<T> rowMapper) {
     ...
     * @return a new Query instance for execution
     */
    public <T> MultipleGeneratedKeysQuery<T>
